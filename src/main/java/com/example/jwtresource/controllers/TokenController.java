...
import com.example.jwtresource.requests.LoginRequest;
import com.example.jwtresource.services.TokenService;
...
public class TokenController {
    ...
    @PostMapping
    public String generate(@RequestBody LoginRequest loginRequest) {
